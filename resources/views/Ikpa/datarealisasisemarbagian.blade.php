...
@section('content')
    ...
    <div class="row">
        ...
        &nbsp;
        &nbsp;
        <a class="btn btn-success text-white btn-sm" href="{{url('ikpa/datasemarbagian').'/'.$satker.'/'.$idbagian}}">Export</a>
    </div>
    <input type="hidden" id="idbagian" value="{{$idbagian}}">
    <input type="hidden" id="satker" value="{{$satker}}">
    <br>
    <br>
    <table id="realisasisemarbagian-datatable" class="table table-bordered realisasisemarbagian-datatable" style="width: 100%; word-break: break-all">
        <thead>
        <tr>
...
@section('js')
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#realisasisemarbagian-datatable tfoot th').each( function (i) {
                var title = $('#realisasisemarbagian-datatable thead th').eq( $(this).index() ).text();
            ...
            var table = $('.realisasisemarbagian-datatable').DataTable({
                fixedColumn:true,
                scrollX:"100%",
                autoWidth:true,
                processing: true,
                ...
                ajax:"{{url('ikpa/getdatasemarbagian')}}"+'/'+idbagian+'/'+satker,
                columns: [
